...
ALTER TABLE public.purchase_orders_purchase_id_seq OWNER TO postgres;
...
--
-- Name: sales_orders_sales_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.sales_orders_sales_id_seq OWNER TO postgres;

--
-- Name: sales_orders_sales_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: sales_orders sales_id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_orders_purchase_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: sales_orders_sales_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: purchase_items purchase_items_manufacturer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sales_items sales_items_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sales_items sales_items_sales_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: sales_orders sales_orders_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
